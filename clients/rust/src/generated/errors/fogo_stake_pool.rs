...
pub enum FogoStakePoolError {
    ...
    /// 43 - Epoch reward distribution is currently in progress
    #[error("Epoch reward distribution is currently in progress")]
    EpochRewardDistributionInProgress = 0x2B,
    /// 44 - The stake pool has too many validators
    #[error("The stake pool has too many validators")]
    TooManyValidatorsInPool = 0x2C,
}

impl From<FogoStakePoolError> for solana_program_error::ProgramError {
    fn from(e: FogoStakePoolError) -> Self {
