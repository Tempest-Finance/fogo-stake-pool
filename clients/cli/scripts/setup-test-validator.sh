...
setup_test_validator() {
  solana-test-validator \
    --clone-upgradeable-program SP1s4uFeTAX9jsXXmwyDs1gxYYf7cdDZ8qHUHVxE1yr \
  ...
  #solana-test-validator \
  #  --bpf-program SP1s4uFeTAX9jsXXmwyDs1gxYYf7cdDZ8qHUHVxE1yr ../../../target/deploy/spl_stake_pool.so \
